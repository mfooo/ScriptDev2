...
-- Dark Fiend
UPDATE `creature_template` SET `faction_A` = '14', `faction_H` = '14', `speed_run` = '0.6', `ScriptName` = 'dark_fiend' WHERE `entry` = 25744; 
-- Void Sentinel
...
-- Singularity
UPDATE creature_template SET `faction_A` = '14', `faction_H` = '14', `speed_run` = '1', `rank` = '1', `AIName` = '', `ScriptName` = 'mob_singularity' WHERE `entry` = 25855; 
